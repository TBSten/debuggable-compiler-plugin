...
1) Run `./gradlew :debuggable-runtime:publishToMavenLocal`
2) Open `~/.m2/repository/me/tbsten/debuggable/`
...
2) Add developer id, name, email and the project url to  
   `./debuggable-runtime/build.gradle.kts`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :debuggable-runtime:publishAndReleaseToMavenCentral --no-configuration-cache`
