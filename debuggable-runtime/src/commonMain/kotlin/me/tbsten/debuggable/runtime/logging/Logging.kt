...
fun logAction(receiver: Any?, name: String, vararg args: Any?, logger: DebugLogger = DefaultDebugLogger, stackTrace: String = "") {
    ...
    logger.log(receiver, label, DebugLogger.NoValue)
}
